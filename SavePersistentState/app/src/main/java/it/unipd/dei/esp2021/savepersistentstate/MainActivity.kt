...
class MainActivity : AppCompatActivity()
{
    // Class constants
    companion object {
        private const val KEY_ETCOLOR = "editTextValue"
        private const val KEY_SBSIZE = "seekBarValue"
        private const val KEY_CBALLCAPS = "checkBoxValue"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        // Set the relevant status of widgets according to persistent data
    ...
    override fun onPause()
    {
        ...
        editor.putBoolean(KEY_CBALLCAPS, cbAllCaps.isChecked)
